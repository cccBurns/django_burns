...
from hardware.models import Procesador, Placa, Monitor
from django.urls import reverse_lazy
from django.contrib.auth.mixins import LoginRequiredMixin
from django.contrib.auth.decorators import login_required
from hardware.forms import CrearMonitorFormulario, BusquedaMonitorFormulario, ActualizarMonitorFormulario
...
def crear_monitor(request):    
    ...
    if request.method == 'POST':
        ...
        if formulario.is_valid():
            ...
            return render(request, 'hardware/crear_monitor.html', {'formulario': formulario})
